...
gdl_dock_item_class_init (GdlDockItemClass *klass)
{
	...
	g_object_class_install_property (
		...
		g_param_spec_boolean ("resize", _("Resizable"),
		   ...
		   TRUE,
		   G_PARAM_READWRITE |
		   GDL_DOCK_PARAM_EXPORT));/* hacked */
	
	g_object_class_install_property (
		object_class, PROP_SHRINK,
		g_param_spec_boolean ("shrink", _("Shrinkable"),
							  _("Can this child be made smaller "
                             ...
                             GParamSpec   *pspec)
{
    ...
    switch (prop_id) {
        ...
        case PROP_RESIZE:
            ...
            break;
		case PROP_SHRINK:
			item->priv->shrink = g_value_get_boolean (value);
			break;
        case PROP_BEHAVIOR:
        {
                             ...
                             GParamSpec   *pspec)
{
    ...
    switch (prop_id) {
        ...
        case PROP_RESIZE:
            ...
            break;
		case PROP_SHRINK:
			g_value_set_boolean (value, item->priv->shrink);
			break;
        case PROP_BEHAVIOR:
